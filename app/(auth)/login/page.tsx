  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h1 className="font-extrabold text-2xl text-text-primary">Selamat Datang Kembali</h1>
        <p className="text-xs text-text-muted mt-1">Masuk ke akun Taskara Anda untuk melanjutkan</p>
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-4">
        <div>
          <label className="block text-xs font-bold text-text-primary mb-1">Email Kampus / Bisnis</label>
        ...
        >
          {isLoading ? "Memproses..." : "Masuk ke Akun"} <ArrowRight className="h-4 w-4" />
        </button>
      </form>
